...
- Web: [halykcoin.org](https://halykcoin.org/)
- Forum: [bitcointalk.org](https://bitcointalk.org/index.php?topic=3076077)
- GitHub: [https://github.com/HalykCoin/halykcoin/](https://github.com/HalykCoin/halykcoin/)
- Telegram: [Rus Halykcoin](https://t.me/halykchannel)
...
## Compiling Halykcoin from Source
...
Halykcoin uses the CMake build system and a top-level [Makefile](Makefile) that
...
* Add `PATH="$PATH:$HOME/halykcoin/build/release/bin"` to `.profile`

* Run Halykcoin with `halykcoind --detach`
...
To list all available options, run `./bin/halykcoind --help`.  Options can be
...
[halykcoind.service](utils/systemd/halykcoind.service) to `/etc/systemd/system/` and
[halykcoind.conf](utils/conf/halykcoind.conf) to `/etc/`. The [example
service](utils/systemd/halykcoind.service) assumes that the user `halykcoin` exists
and its home is the data directory specified in the [example
config](utils/conf/halykcoind.conf).
